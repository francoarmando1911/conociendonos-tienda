    ...
    return (
        <div className="flex flex-col items-center p-6">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 w-full max-w-5xl">
                ...
                <Link to="/descuentos" aria-label="Prueba" className="p-6 bg-[#f9c1d3] text-white text-center rounded-lg shadow-lg hover:bg-blue-400 hover:scale-105 transition transform duration-200 ease-in-out">
